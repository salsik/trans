...
class IOS {
    ...
    function send_push($deviceToken, $data) {
        ...
        stream_context_set_option($ctx, 'ssl', 'local_cert', '/var/www/dermaconnect/data/www/jpint.dermaconnectonline.com/_push_notifications/production_com.advancesandmore.jpdermaint.pem');
