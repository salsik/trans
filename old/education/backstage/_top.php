...
<?php if( defined('Access_calendar') ) { ?>
    ...
    <script src="js/wdCalendar/jquery.ifrmdailog.js" defer type="text/javascript"></script>
...
.loader {
    ...
    left: 0;
    z-index: 10;
    background: rgba(255,255,255,0.6) url(images/wait.gif) no-repeat center center;
}
.students_list {
    clear: both;
...
/*Adds*/
/*fieldset.ckeditor-wrapper label {
    float: none;
}*/
</style>
...
<!--			<h2 class="section_title">Welcome <?php echo ucwords( (isAdmin) ? $Admin['full_name'] : $Admin['title'] ); ?></h2>-->
		</hgroup>
	</header> <!-- end of header bar -->
	
	<section id="secondary_bar">
		<div class="user">
		<p><?php echo ucwords( (isAdmin || isSchoolAdmin) ? $Admin['full_name'] : $Admin['title'] ); ?> (<a href="logout.php">Logout</a>)</p>
