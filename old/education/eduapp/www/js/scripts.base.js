...
//_log("_do_login", 'One');
	...
	_load_categories($categories_gallery, '#menu_school_gallery_menu', '#school_gallery_cat');
        _notifications_counters(loggedin.notifications);
        
        $("#menu_education_news").on('click', function(){
            $("#menu_education_news_menu").toggleClass('hide');
        });
        $("#menu_school_news").on('click', function(){
            $("#menu_school_news_menu").toggleClass('hide');
        });
        $("#menu_school_documents").on('click', function(){
            $("#menu_school_documents_menu").toggleClass('hide');
        });
        $("#menu_school_gallery").on('click', function(){
            $("#menu_school_gallery_menu").toggleClass('hide');
        });
...
function _notifications_counters(notifications){
    
    if( notifications.agenda ){
        $("#agenda_counter").text(notifications.agenda);
    }
    if( notifications.gallery ){
        $("#gallery_counter").text(notifications.gallery);
    }
    if( notifications.videos ){
        $("#videos_counter").text(notifications.videos);
    }
