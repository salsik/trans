 ...
 * */
/*
ALTER TABLE  `news` ADD  `pushed` ENUM(  '',  '1' ) NOT NULL; ALTER TABLE `news` ADD INDEX (`pushed`);
ALTER TABLE  `education_news` ADD  `pushed` ENUM(  '',  '1' ) NOT NULL; ALTER TABLE `education_news` ADD INDEX (`pushed`);
ALTER TABLE  `documents` ADD  `pushed` ENUM(  '',  '1' ) NOT NULL; ALTER TABLE `documents` ADD INDEX (`pushed`);
ALTER TABLE  `gallery` ADD  `pushed` ENUM(  '',  '1' ) NOT NULL; ALTER TABLE `gallery` ADD INDEX (`pushed`);
ALTER TABLE  `videos` ADD  `pushed` ENUM(  '',  '1' ) NOT NULL; ALTER TABLE `videos` ADD INDEX (`pushed`);
ALTER TABLE  `agenda` ADD  `pushed` ENUM(  '',  '1' ) NOT NULL; ALTER TABLE `agenda` ADD INDEX (`pushed`);
ALTER TABLE  `questions_replies` ADD  `pushed` ENUM(  '',  '1' ) NOT NULL; ALTER TABLE `questions_replies` ADD INDEX (`pushed`);

UPDATE `news` SET `pushed`='1';
UPDATE `education_news` SET `pushed`='1';
UPDATE `documents` SET `pushed`='1';
UPDATE `gallery` SET `pushed`='1';
UPDATE `videos` SET `pushed`='1';
UPDATE `agenda` SET `pushed`='1';
UPDATE `questions_replies` SET `pushed`='1';

UPDATE `news` SET `pushed`='';
UPDATE `education_news` SET `pushed`='';
UPDATE `documents` SET `pushed`='';
UPDATE `gallery` SET `pushed`='';
UPDATE `videos` SET `pushed`='';
UPDATE `agenda` SET `pushed`='';
UPDATE `questions_replies` SET `pushed`='';


UPDATE `news` SET `pushed`='1' WHERE id IN( SELECT data_sync.id  FROM `data_sync` WHERE data_sync.`table`='news' );
UPDATE `education_news` SET `pushed`='1' WHERE id IN( SELECT data_sync.id  FROM `data_sync` WHERE data_sync.`table`='education_news' );
UPDATE `documents` SET `pushed`='1' WHERE id IN( SELECT data_sync.id  FROM `data_sync` WHERE data_sync.`table`='documents' );
UPDATE `gallery` SET `pushed`='1' WHERE id IN( SELECT data_sync.id  FROM `data_sync` WHERE data_sync.`table`='gallery' );
UPDATE `videos` SET `pushed`='1' WHERE id IN( SELECT data_sync.id  FROM `data_sync` WHERE data_sync.`table`='videos' );
UPDATE `agenda` SET `pushed`='1' WHERE id IN( SELECT data_sync.id  FROM `data_sync` WHERE data_sync.`table`='agenda' );
UPDATE `questions_replies` SET `pushed`='1' WHERE id IN( SELECT data_sync.id  FROM `data_sync` WHERE data_sync.`table`='questions_replies' );
...
function getDataSql( $table, $catid ='' ) {
	...
	$sql = "SELECT {$table}.id as row_id, {$table}.title as row_title, users.id as user_id, students.school_id {$newsAppNotification} {$catid}
...
//			SELECT {$table}_students.{$field_id} as row_id, {$table}_students.student_id 
			$sql = "
				SELECT {$table}_students.{$field_id} as row_id, {$table}.title as row_title, users.id as user_id, students.school_id {$newsAppNotification} {$catid}
