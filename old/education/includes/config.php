...
if (ONLINE){
 #online 
	...
	$dbUser="previsionpro";
	$dbPass="A8w1K2m2";
	$dbDatabase="previsionpro";

	if( !$_SERVER['HTTP_HOST'] )
	{
	 	$_SERVER['HTTP_HOST'] = 'previsionpro.com/education';
	}
 ...
 #offline
	...
	$dbUser="root";
	$dbPass="root";
	$dbDatabase="prevision_education";
	...
	define('BASE_URL', 'http://'.$_SERVER['HTTP_HOST'].'/techram/prevision_schools/'); // with the last slash

	function today(){ return mktime(date("H"),date("i"),date("s"),date("m"),date("d"),date("Y"));}
}


define("BASE_EMAIL_FROM_name", "Prevision Schools");
...
define('EMAIL_ADMIN','chawkimatta@gmail.com');      
define('EMAIL_TRACKING','chawkimatta@gmail.com');   

# Project
define('COOKIE','vis'); //Project Identity
define('PROJECT_NAME','Prevision Schools CMS');
define('PROJECT_VER','1.0');

#Used in the "from" field in all e-mails sent from this e-mail
define('EMAIL_FROM','chawkimatta@gmail.com'); 
define('EMAIL_FROM_2','chawkimatta@gmail.com'); 
