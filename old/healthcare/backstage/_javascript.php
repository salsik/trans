...
// for admin panel to delete notifications
function conf_notif(){
	 if (confirm("Are you sure you want to delete all notifications ?"))
	 {

	 	//echo $filename; ?>?menu=<?=$menu?>&sub=<?=$sub?>&p=<?=$p?>&action=delete"
		 // document.getElementById('del').action='<? echo $filename; ?>'+'?'+menu+'action=deletenotif'; 

		  document.getElementById('del').action="<? echo $filename; ?>?menu=<?=$menu?>&sub=<?=$sub?>&p=<?=$p?>&action=deletenotif"  ;
		  document.getElementById('del').submit(); 
	  }
