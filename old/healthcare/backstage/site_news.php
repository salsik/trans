...
define('THUMB_WIDTH', 130); // 218
define('THUMB_HEIGHT', 130); // 150
    ...
    case "record":
        ...
        <form action="<?php echo $filename; ?>?<?php echo $queryStr; ?>p=<?= $p ?>" method="post" name="myform" enctype="multipart/form-data">
            ...
            <article class="module width_full">
                <header><h3>Prevision News: <?php echo ucwords($action); ?> Record
...
//				$sql[] = " site_news.status='' ";
        ...
        if ($action == 'export') {
            ...
            $excel = new export_excel("Prevision News");
        ...
        <form action="<?php echo $filename; ?>?<?php echo $queryStr; ?>p=<?= $p ?>&action=delete" method="post" name="del" id="del">
            <article class="module width_full">
                <header><h3 class="tabs_involved">Prevision News Manager</h3>
                    <ul class="tabs">
                        <?php if ($AllowAdd) { ?>
