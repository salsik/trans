...
# Session Time
define('SESSION_TIME','7200000'); //2 hours
...
function do_logout()
{
	...
	$objRS2=mysql_query( "UPDATE doctors SET sessid='',sesstime='0',logintime='0' WHERE sessid='".mysql_real_escape_string( $_SESSION['adminAuth'] )."' " );
	session_destroy();
	// remove cookies //
