...
# Session Time
define('SESSION_TIME','720000000'); //2 hours
...
function do_logout()
{
	...
	$objRS2=mysql_query( "UPDATE resellers SET sessid='',sesstime='0',logintime='0' WHERE sessid='".mysql_real_escape_string( $_SESSION['adminAuth'] )."' " );
	session_destroy();
	// remove cookies //
	setcookie("adminAuthLeft","",today()-3600*24*14000,'/');
	setcookie("adminAuthRight","",today()-3600*24*14000,'/');
	return true;
}
